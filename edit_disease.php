...
if (!$result) {
   die("Query failed: " . mysqli_error($connection));
      ...
      ?>
      <script>alert("Disease updated successfully");document.location="list_disease.php";</script>
      <?php 
                  ...
                  <form action="" method="post">
                    <div class="row">
                      ...
                      <?php
						...
						$id = $_GET['view'];
						$get = mysqli_query($connection,"select * from disease_info where id = '$id'");
