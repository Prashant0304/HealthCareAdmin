...
if(isset($_POST['update'])){
  ...
  if($appointmentDate_Time=="" || empty($appointmentDate_Time)){
   header('location:index.php?message=You need to fill in the Appointment Date!');
  }
   ...
   UPDATE `appointment_info` SET 
    `appointmentDate_Time`='$appointmentDate_Time', 
...
if (!$result) {
   die("Query failed: " . mysqli_error($connection));
      ...
      ?>
      <script>alert("Appointment updated successfully");document.location="list_appointment.php";</script>
      <?php 
                  ...
                  <form action="" method="post">
                    <div class="row">
                      ...
                      <?php
						...
						$id = $_GET['view'];
						$get = mysqli_query($connection,"select * from appointment_info where id = '$id'");
						while($res = mysqli_fetch_array($get))
						{
							$appointmentDate_Time = $res['appointmentDate_Time'];
                       ...
                       <div class="col-12 col-md-6 col-xl-6">
                        <div class="form-group local-forms">
                          ...
                          <select name="patient_id" class="form-control">
							...
							{
							?>
							<option <?php if($patient_id == $allemparr['Id']) { echo "selected";} ?> value="<?php echo $allemparr['Id'];?>"><?php echo $allemparr['Name'];?></option>
							<?php
							}
							?>
                          </select> 
                       ...
                       <div class="col-12 col-md-6 col-xl-6">
                        <div class="form-group local-forms">
                          ...
                          <select name="disease_id" class="form-control">
                           <option value="">Select</option>
                          <?php
							$allemp1 = mysqli_query($connection,"select * from disease_info order by Title");
							while($allemparr1 = mysqli_fetch_array($allemp1))
							{
							?>
							<option <?php if($disease_id == $allemparr1['id']) { echo "selected"; } ?>  value="<?php echo $allemparr1['id'];?>"><?php echo $allemparr1['Title'];?></option>
							<?php
							}
							?>
                          </select> 
                      ...
                      <div class="col-12 col-md-6 col-xl-6">
                        <div class="form-group local-forms">
                          <label>Appointment <span class="login-danger">*</span>
                          </label>
