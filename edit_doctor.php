...
if(isset($_POST['update'])){
  ...
  elseif($Kims_id=="" || empty($Kims_id)){
   header('location:index.php?message=You need to fill in the KIMS ID!');
   }
...
if (!$result) {
   die("Query failed: " . mysqli_error($connection));
      ...
      ?>
      <script>alert("Doctor updated successfully");document.location="list_doctor.php";</script>
      <?php 
...
<html lang="en">
  <head>
    ...
    <title>Curilux - list Doctor</title>
                  ...
                  <form action="" method="post">
                    <div class="row">
                      ...
                      <?php
						...
						$id = $_GET['view'];
						$get = mysqli_query($connection,"select * from doctor_info where id = '$id'");
