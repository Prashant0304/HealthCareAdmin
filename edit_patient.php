...
if (!$result) {
   die("Query failed: " . mysqli_error($connection));
      ...
      ?>
      <script>alert("Patient updated successfully");document.location="list_patient.php";</script>
      <?php 
                  ...
                  <form action="" method="post">
                    <div class="row">
                      ...
                      <?php
						...
						$id = $_GET['view'];
						$get = mysqli_query($connection,"select * from patient_info where Id = '$id'");
						while($res = mysqli_fetch_array($get))
						{
							...
							$Genetic_diseases = $res['Genetic_diseases'];
							$Address = $res['Address'];
							$Contact = $res['Contact'];
						}
