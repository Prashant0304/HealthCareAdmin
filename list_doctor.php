...
if(isset($_GET['id'])){
  $id=$_GET['id'];
  $query= "delete from doctor_info where id=$id";
  $result=mysqli_query($connection,$query);
  if(!$result){
  echo "Query failed: " . mysqli_error($connection);
    ...
    ?>
    <script>alert("Doctor deleted successfully");document.location="list_doctor.php";</script>
    <?php 
  }
}
              ...
              <div class="card">
                <div class="card-body">
                  <div class="table-responsive">
                    ...
                    <td><?php echo $row['Kims_id']; ?></td>
                    <td><?php echo $row['Contact']; ?></td>
                          <td class="text-end">
                            <a href="edit_doctor?view=<?php echo $row['id'];;?>" class="btn btn-sm btn-white text-success me-2">
                              <i class="far fa-edit me-1"></i> Edit </a>
                            <a onclick="return confirm('Are you sure you want to delete this?');" class="btn btn-sm btn-white text-danger" href="list_doctor?id=<?php echo $row['id'];?>" >
