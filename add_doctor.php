...
if(isset($_POST['submit'])){
  ...
  elseif($Kims_id=="" || empty($Kims_id)){
     header('location:index.php?message=You need to fill doctors KIMS id!');
  }
   ...
   elseif($Contact=="" || empty($Contact)){
     ...
     $query = "INSERT INTO doctor_info (Name,Age,Kims_id,Contact) VALUES ('$Name',$Age,'$Kims_id','$Contact')";
...
if (!$result) {
   die("Query failed: " . mysqli_error($connection));
      ...
      ?>
      <script>alert("Doctor added successfully");document.location="add_doctor.php";</script>
      <?php 
     }
...
<html lang="en">
  <head>
    ...
    <title>Curilux - Add Doctor</title>
            ...
            <div class="row">
              <div class="col-sm-12">
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active"><?php if(isset($_GET['view'])) { echo "Update";} else { echo "Add";} ?> Doctor</li>
                </ul>
              </div>
            </div>
          </div>
                  ...
                  <form action="" method="post">
                    <div class="row">
                      ...
                      <div class="alert alert-danger alert-dismissible fade show" data-mdb-delay="3000" role="alert">
						<strong>Error!</strong> Doctor Phone Exists
						<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
						<span aria-hidden="true"> </span>
						</button>
						</div>
                      ...
                      <div class="col-12 col-md-6 col-xl-6">
                        <div class="form-group local-forms">
                          <label>KIMS ID <span class="login-danger">*</span>
                          </label>
                          <input name="Kims_id" id="Kims_id" class="form-control" type="text" value="<?php echo $Kims_id;?>" required>
                        </div>
                      </div>
                      <div class="col-12 col-md-6 col-xl-6">
                        <div class="form-group local-forms">
